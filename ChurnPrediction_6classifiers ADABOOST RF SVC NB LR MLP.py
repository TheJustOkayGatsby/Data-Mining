...
# Tuning hyperparameters learning rate, max_iter, regularization parameter alpha and l1 ratio and implementing cross-validation using Grid Search
model = Pipeline([
        ('balancing', SMOTE(random_state = 101)),
...
# Tuning the MLP parameters 'learning_rate_init', and 'max_iter' and implementing cross-validation using Grid Search
model = Pipeline([
        ('balancing', SMOTE(random_state = 101)),
        ('classification', MLPClassifier(hidden_layer_sizes = (100,), random_state=1)) # hidden_layer_sizes determines the number of layers and the number of units within those layers. It can be a hyperparameter
    ])
